...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                ...
                <strong><a href="index.html"><img src="{{url('img/logo/logosn.png')}}" alt="" /></a></strong>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="" href="/pelanggan/dashboard">
								  <i class="fa fa-home"></i>
								   <span class="mini-click-non">Dashboard</span>
                            </a>
                        </li>
                        <li>
                            <a class="has-arrow" href="all-professors.html" aria-expanded="false"><i class="fa fa-table"></i> <span class="mini-click-non">Data Tabel</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="/pelanggan/data-tarif"><span class="mini-sub-pro">Data Tarif</span></a></li>
                            </ul>
                        </li>
                        <li class="">
    ...
    <div class="all-content-wrapper">
        ...
        <div class="header-advance-area">
            ...
            <!-- Mobile Menu end -->
            <div class="breadcome-area margin-top-5">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
